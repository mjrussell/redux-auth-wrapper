...
describe('connectedAuthWrapper', () => {
  ...
  it('passes through props to components', () => {
    ...
    expect(wrapper.find(UnprotectedComponent).length).to.equal(0)
    expect(_.omit(wrapper.find(FailureComponent).props(), ['dispatch', 'location', 'params', 'preAuthAction'])).to.deep.equal({
    ...
    expect(wrapper.find(UnprotectedComponent).length).to.equal(0)
    expect(_.omit(wrapper.find(AuthenticatingComponent).props(), ['dispatch', 'location', 'params', 'preAuthAction'])).to.deep.equal({
    ...
    expect(wrapper.find(UnprotectedComponent).length).to.equal(1)
    expect(_.omit(wrapper.find(UnprotectedComponent).props(), ['dispatch', 'location', 'params', 'preAuthAction'])).to.deep.equal({
